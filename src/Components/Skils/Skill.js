...
import skilimg from "./56922-code-typing-concept.gif";
      ...
      <div className="flex flex-col justify-between items-center lg:flex-row">
        ...
        <div className="px-5 pt-6 pb-5 text-left lg:w-1/2">
          ...
          <p className="my-9  text-gray-600 text-lg">
            ...
            mission is to empower people from all walks of life by breaking down
            barriers to entry and making powerful resources readily available
          </p>

          <div className="list-none ">
            <div className="my-3">
              <h2 className="capitalize text-2xl font-semibold  "> Ninja at</h2>
              <div className="flex  flex-wrap ">
                <li className="  mr-2 text-sm font-serif  pt-1">JAVASCRIPT</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">REACT JS</li>
            ...
            <div className="my-3">
              ...
              <div className="flex flex-wrap">
                ...
                <li className=" mr-2 text-sm font-serif  pt-1 ">REACT JS</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">HTML/CSS</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">
                  UI/UX DESIGN
                </li>
              </div>
            ...
            <div className="my-3 ">
              <h1 className="capitalize text-2xl font-semibold  ">Back-end</h1>
              <div className="flex flex-wrap">
                <li className=" mr-2 text-sm font-serif  pt-1 ">NODE Js</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">REST API</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">EXPRESS JS</li>
              </div>
            </div>

            <div className="my-3">
              <h1 className="capitalize text-2xl  font-semibold  ">Database</h1>
              <div className="flex flex-wrap">
                <li className=" mr-2 text-sm font-serif  pt-1 ">MONGODB</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">FIREBASE</li>
              </div>
            </div>
            ...
            <div className="my-3">
              ...
              <div className="flex flex-wrap">
                <li className=" mr-2 text-sm font-serif  pt-1 ">STRIPE, </li>
              </div>
            </div>
            ...
            <div className="my-3">
              ...
              <div className="flex flex-wrap">
                ...
                <li className=" mr-2 text-sm font-serif  pt-1 ">VERCEL</li>
                <li className=" mr-2 text-sm  font-serif  font-bold  pt-1 ">
                  NETLIFY{" "}
                </li>
              </div>
            ...
            <div className="my-3">
              <h1 className="capitalize text-2xl font-semibold  ">Libraries</h1>
              <div className="flex flex-wrap">
                <li className=" mr-2 text-sm  font-serif  font-bold  pt-1 ">
                  TAILWIND CSS
                </li>
            ...
            <div className="my-3">
              ...
              <div className="flex flex-wrap">
                ...
                <li className=" mr-2 text-sm font-serif  pt-1 ">GITHUB</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">FIGMA</li>
                <li className=" mr-2 text-sm font-serif  pt-1 ">WORDPRESS</li>
                <li className=" mr-2 text-sm  font-serif  font-bold  pt-1 ">
                  GOOGLE MAP
                </li>
              </div>
